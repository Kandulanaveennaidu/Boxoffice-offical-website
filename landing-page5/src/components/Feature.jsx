    ...
    >
      <div className="feature flex items-center justify-center flex-col relative text-center mx-12">
        ...
        <span className="text-[#707070] mt-4">
          ...
          laudantium iusto quae molestias, fugit earum dolorum blanditiis
          pariatur unde qui, accusantium eaque enim hic suscipit quo atque
          corporis tenetur voluptatibus.
        </span>
