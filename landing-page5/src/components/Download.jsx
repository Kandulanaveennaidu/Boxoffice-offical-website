    ...
    <div className="flex flex-col items-center justify-start px-[5rem] bg-[#020917] h-[48rem] pt-[18rem] mt-[-10rem] relative z-[0] rounded-b-[5rem]">
      ...
      <div className="headline mt-7 flex flex-col items-center text-[2rem]">
        ...
        <span className="text-[1rem] text-gray-400 px-[15rem] text-center mt-[1rem]">
          ...
          laboriosam reiciendis provident in non quas repudiandae officiis
          possimus soluta impedit! Aliquam reiciendis alias saepe harum
          quibusdam unde tempore non voluptas?
        </span>
      </div>
      {/* dowload ads */}
      <div className="mt-14">
